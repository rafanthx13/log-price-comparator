...
module.exports = (app) => {
    ...
    // middleware de validação usado em put e post. eu coloco ele na frente do 'post' 'put' e ai vai passar por eles
    const validate = (req, res, next) => {
        // sobrescreve o usuário enviado na transação pelo usuário do token
    ...
    // O put é ter todo o objeto mais certas chaves modificadas, por isso precisa validar tudo
